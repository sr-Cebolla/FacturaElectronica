"""
Django settings for factura_electronica project.
...
SECRET_KEY = 'django-insecure-vk8p#82qh@y51cm7sj6m7ywrtmluu4i)u4tk=3@r9j4d2g$hw='
...
WSGI_APPLICATION = 'factura_electronica.wsgi.application'
